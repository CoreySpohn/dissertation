...
work of \Cref{cha:first_paper} was published as
\citet{spohnSchedulingDirect2022}. Then in \Cref{cha:coupling} I describe a
...
impact on the amount of observational noise. The work of \Cref{cha:coupling}
...
\Cref{cha:coupling} are combined with the probability of detection metric from
\Cref{cha:first_paper} in \Cref{cha:accurate_pdet} to calculate the probability
