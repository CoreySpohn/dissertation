...
\end{itemize}
This section of code makes uses the \code{astroplan} python package to determine
...
RVtoImaging does a blind search for every star with observations in the RV
...
RVtoImaging works on forked versions of RVsearch and RadVel that were created
...
telescope using EXOSIMS's \code{calc\_dMag\_per\_intTime} function. 
...
eliminate dispersion error which was described in \Cref{cha:first_paper}. We
...
used in the \code{EXOSIMS} module {Mennsson} based on
